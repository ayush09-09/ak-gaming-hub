...
const SellerUpload = () => {
  ...
  return (
    ...
    >
      ...
      <ImageUploader label="🧍 Profile Image" name="profile" onChange={handleImageChange} />
      <ImageUploader label="🎮 Lobby Image" name="lobby" onChange={handleImageChange} />
      <ImageUploader label="🔫 Weapon Image" name="weapon" onChange={handleImageChange} />
      <ImageUploader label="🎒 Vault Image" name="vault" onChange={handleImageChange} />
      <ImageUploader label="🧙 Character Image" name="character" onChange={handleImageChange} />
